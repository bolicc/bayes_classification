...
public class Training {
 ...
 /* public static class DataSelecter implements MapFunction<Tuple3<String, String, Long>, Tuple2<String, Long>> {
    @Override
    public Tuple2<String, Long> map(Tuple3<String, String, Long> in) {
      return new Tuple2<String, Long>(in.f0,in.f2);
    }
  }*/
}
